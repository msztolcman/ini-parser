...
ok($parser->feed ('t/import.ini', { src_type => 'filename' }), 'feed t/import.ini, there is import clause');
...
is($parser->section('section1')->get('key1'), 'value12', 'get single line value - overwritten by imported file');
...
is($parser->section('section1')->get('key13'), 'value13', 'added value from imported file to existent section');
is($parser->section('section5')->get('key14'), 'value14', 'added value from imported file, from new section');
